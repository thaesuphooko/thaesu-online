      ...
      >
        <div className="backdrop-blur-xl bg-white/5 border border-white/10 rounded-3xl p-8 shadow-2xl shadow-purple-500/20">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="relative">
              ...
              <input
                ...
                required
                className="w-full pl-10 pr-4 py-3 bg-black/30 border border-white/10 rounded-xl text-white placeholder-gray-500 focus:border-purple-500 focus:outline-none transition"
              />
            </div>
            ...
            <div className="relative">
              ...
              <input
                ...
                name="store_slug"
                ref={slugRef}
                placeholder="Store Slug (e.g., my-shop)"
              ...
              <p className="text-xs text-gray-500 mt-1 ml-1">
                This will be your store URL: /vendor/{form.store_slug || "my-shop"}
              </p>
            </div>
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className="w-full py-3 px-6 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-500 hover:to-pink-500 rounded-xl font-bold text-lg transition-all flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {loading ? (
          ...
          <p className="text-center text-sm text-gray-400 mt-6">
            ...
            <Link href="/vendor/login" className="text-purple-400 hover:underline">
              Sign in
            </Link>
          </p>
        </div>
